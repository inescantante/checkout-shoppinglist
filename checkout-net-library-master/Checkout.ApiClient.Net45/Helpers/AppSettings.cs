...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        private const string _shoppingListUrl = "http://localhost:59719/api";
        ...
        {
            get { return _consumerName ?? (_consumerName = ReadConfig("Checkout.ConsumerName", true)); }
            ...
            set
            {
                switch (value)
                {
                    ...
                    case CheckoutEnvironment.Sandbox:
                        ...
                        break;
                    case CheckoutEnvironment.ShoppingList:
                        _baseApiUri = _shoppingListUrl;
                        break;
                };
                _environment = value;
