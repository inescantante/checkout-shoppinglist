...
public class ApiUrls
{
    ...
    {
        get { return _shoppingListApiUri ?? (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist")); }
    }

    public static string ShoppingListItem
    {
        get { return _shoppingListItemApiUri ?? (_shoppingListItemApiUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/{0}")); }
    }
}
